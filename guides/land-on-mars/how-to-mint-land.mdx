---
title: "How to Get Land in the Metaverse"
...
<Steps>
  ...
  <Step title="Connect Your Wallet">
    ...
    Before you can mint land, make sure your wallet is connected.

    - Make sure you're connected to **Ethereum mainnet**
    - You can use any EVM-compatible wallet (e.g., MetaMask).
    - Land is minted on Ethereum, but it will be delivered on Rufus Chain.

    <Info>
      Your land will be airdropped to the same wallet you used to mint, on Rufus Chain, within 24 hours.
    </Info>
  </Step>
  <Step title="Mint Land">
    ...
    <Tip>
      Reminder: The Metaverse goes live June 30th.
    </Tip>
    ### ✅  Finalize the Mint
